...
type Branding = { siteName:string; logo:string; favicon:string; primary:string; secondary:string; accent:string; browserTitle:string };
...
const defaultBranding = (name:string):Branding => ({siteName:name,logo:'',favicon:'',primary:'#1f5eff',secondary:'#0f172a',accent:'#38bdf8',browserTitle:name});
